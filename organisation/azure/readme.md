...
Debug Managed Service 
- az provider register --namespace Microsoft.ManagedServices --subscription <subscription-id> --wait
- az provider register --namespace Microsoft.ManagedServices --wait
- az provider show --namespace Microsoft.ManagedServices --subscription <subscription-id> --query "registrationState"
